...
tf.flags.DEFINE_string("training_files", "../../data/SQRD-train.txt", "training file (default: None)")
tf.flags.DEFINE_string("dev_files", "../../data/SQRD-test.txt", "dev file (default: None)")
...
with tf.Graph().as_default():
    ...
    def train_step(x1_batch, x2_batch, y_batch):
        ...
        _, input1, embed, step, loss, accuracy, dist, sim, summaries = sess.run(
            [tr_op_set, siameseModel.input_x1, siameseModel.embedded_chars1, global_step, siameseModel.loss, siameseModel.accuracy, siameseModel.distance, siameseModel.temp_sim, train_summary_op],  feed_dict)
    ...
    def dev_step(x1_batch, x2_batch, y_batch):
        ...
        step, loss, accuracy, dist, sim, summaries = sess.run([global_step, siameseModel.loss, siameseModel.accuracy, siameseModel.distance, siameseModel.temp_sim, dev_summary_op],  feed_dict)
        time_str = datetime.datetime.now().isoformat()
